...
use crate::{
    ...
    config::McpApiKey,
    mcp::{
        INTERNAL_ERROR, INVALID_REQUEST, JsonRpcError, JsonRpcRequest, JsonRpcResponse, McpServer,
        PARSE_ERROR,
...
fn adopt_session(state: &AdminState, server: &McpServer, session_id: Option<&str>) {
