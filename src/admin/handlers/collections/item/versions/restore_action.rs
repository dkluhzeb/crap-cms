...
use crate::{
    ...
    core::{CollectionDefinition, Document, auth::AuthUser, spawn_request_blocking},
...
pub async fn restore_version(
    ...
    let result = spawn_request_blocking(move || restore_collection_version_blocking(&input)).await;
