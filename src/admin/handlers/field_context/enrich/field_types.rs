...
use crate::admin::handlers::field_context::builder::{
    apply_field_type_extras, build_single_field_context,
};
use crate::admin::handlers::field_context::{count_errors_in_fields, safe_template_id};
...
pub(super) fn enrich_richtext(ctx: &mut serde_json::Value, reg: &crate::core::Registry) {
